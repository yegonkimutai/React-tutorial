...
**[React-tutorial]** is a project of creating a Todo list using React. It also involves adding fuctionality that enables the list to function effrctively.
...
- [Live Demo Link](https://to-do-reac.onrender.com)
...
```sh
  cd my-folder
  git clone https://github.com/yegonkimutai/React-tutorial.git
```
